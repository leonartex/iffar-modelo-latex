...
\footnotetext{O funcionamento pleno deste comando em todas as situações não é garantido. Foi realizada a adaptação de dois códigos distintos e, sendo bem honesto, não entendo exatamente bem como funciona a parte lógica do \texttt{biblatex}.}
