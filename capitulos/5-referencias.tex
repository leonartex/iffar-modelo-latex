...
O \texttt{biblatex-abnt} introduz um conjunto de comandos para citações apud. 
...
\singlecite{seriado:fullmetal}
\begin{verbatim}
@movie{seriado:fullmetal,
title        = {Fullmetal Alchemist},
subtitle     = {Brotherhood},
edition      = {Criação: Hiromu Arakawa. Direção: Yasuhiro 
Irie, Kiyomitsu Sato},
location     = {Japão},
publisher    = {Bones},
year         = {2009},
howpublished = {Temporada 1, episódio 4. Título do episódio: 
A Angústia de um Alquimista.},
}
\end{verbatim}
