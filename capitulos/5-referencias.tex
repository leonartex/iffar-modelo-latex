...
\subsubsection{Elementos adicionais na citação}\index{Referencias bibliograficas@Referências bibliográficas!Citar elementos adicionais}
...
Para as citações simultâneas\index{Citacao simultanea@Citação simultânea|seealso{Citar elementos adicionais}} ou citações apud\index{Apud|seealso{Citar elementos adicionais}} segue-se o mesmo padrão ao utilizar os colchetes:
