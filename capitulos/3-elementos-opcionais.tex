...
\section{Parte externa}
    ...
    É configurado automaticamente pelo arquivo \texttt{elementos/DADOS.tex}. Nele, selecione se o seu trabalho é TCC ou Tese e Dissertação e preencha os dados restantes com os valores necessários.
...
\subsection{Dedicatória (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/dedicatoria.tex}| para não adicionar o elemento.
...
\subsection{Agradecimentos (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/agradecimentos.tex}| para não adicionar o elemento.
...
\subsection{Epígrafe (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/epigrafe.tex}| para não adicionar o elemento.
...
\subsection{Lista de abreviaturas e siglas (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/lista-siglas.tex}| para não adicionar o elemento.
...
\subsection{Lista de símbolos (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/lista-simbolos.tex}| para não adicionar o elemento.
...
\subsection{Glossário (opcional)}
    ...
    Em \texttt{main.tex}, comente a linha \verb|\include{elementos/glossario.tex}| para não adicionar o elemento.
