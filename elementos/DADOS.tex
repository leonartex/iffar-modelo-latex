...
%%  IMPORTANTE
%%%%
\newcommand{\isTCC}{0} % Se o seu trabalho for TCC, coloque 1. Mas se o seu trabalho não for um TCC, ou seja, é tese ou dissertação, coloque 0. Esse comando é usado para verificar e então configurar algumas páginas, como capa, folha de rosto e folha de aprovação/certificação
