...
\include{elementos/capa.tex}
\include{elementos/folha-rosto.tex}
\include{elementos/folha-aprovacao.tex}
\begin{SecoesNaoNumeradas}
  ...
  \include{elementos/resumo.tex}
  \include{elementos/abstract.tex}
...
\begingroup
  \input{capitulos/exemplos-secoes.tex}
\endgroup

\begingroup
  \input{capitulos/elementos-comuns.tex}    
