...
%% Criar as partes de Apêndice e Anexos para permitir a listagem
% Fonte: https://tex.stackexchange.com/questions/394112/define-new-section
%Crio o Apêndice
...
%% Agora customizo as seções e sumário para seguirem as normas do IFFar (itens adicionais do sumário também são configurados nesses arquivos)
...
\begingroup
  ...
  \paragraph{Seção quinária} % Utiliza-se paragraph para o nível hierarquico inferior à subsubsection. Contudo, foi necessário customizá-lo para apresentar corretamente como um nível de seção
  \lipsum[5-5]
\endgroup
...
\begingroup
\apendice{Teste}\label{apendice:teste}
\lipsum[6-7]
\endgroup

\begingroup 
\anexo{Teste}\label{anexo:teste}
\lipsum[6-7]
\endgroup
