...
% É necessário que o pacote do índice fique após o pacote hyperref, por causa que ele afeta a identificação dos comandos \see e \seealso como próximos caracteres, para a impressão de vírgula ou não. Por um lado, sacrifica-se a praticidade dos links (o que seria muito bacana de ter), por outro, não seguiria corretamente o padrão NBR 6034 (que nem mesmo a ABNT parece seguir exatamente como padroniza, como no índice da NBR 6023:2018?)
