...
% Acesso pelo Overleaf: https://www.overleaf.com/read/fyhtfsbxnfhp
...
% Configurando o espaço entre os floats (figura, tabelas, quadro, etc.). Por algum motivo, utilizar \baselineskip faz ficar com um baita espaço
...
\hypersetup{
  ...
  pdfsubject={[Insira o assunto/tema de seu trabalho (talvez um resuminho rápido?) Deve ser válido citar que se trata de um TCC, tese ou dissertação, de determinado curso, que é do IFFar. Esse tipo de coisa]},
